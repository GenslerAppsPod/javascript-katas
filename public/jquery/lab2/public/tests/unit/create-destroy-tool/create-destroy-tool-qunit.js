...
(function (gensler, $) {
    ...
    module("Createdestroytool", {
        setup: function () {
            var fixture = $('#qunit-fixture');
            fixture.createdestroytool();
            equal($('.gensler-createdestroytool').length, 1, 'tool is present');
        },
        teardown: function () {
            var fixture = $('#qunit-fixture');
            fixture.createdestroytool('destroy');
            equal($('.gensler-createdestroytool').length, 0, 'tool is destroyed');
        }
    });
