...
(function (gensler, $, undefined) {
    ...
    $.widget("gensler.createdestroytool", {
        ...
        options: {
            ...
            instance: {
                ...
                namespace: 'gensler',
                name: 'createdestroytool',
                tool: undefined // filled in during create
            },
            // callbacks
            create: function (event, data) {
                // pass a callback,or simply bind on the "createdestroytool:create" event, or both
                //console.log(event, '--callback create event')
                //console.log(data, '--callback create data')
            },
            change: function (event, data) {
                // pass a callback,or simply bind on the "createdestroytool:change" event, or both
                //console.log(event, '--callback change event');
                //console.log(data, '--callback change data');
            },
            destroy: function (event, data) {
                // pass a callback,or simply bind on the "createdestroytool:destroy" event, or both
