    ...
    $.widget("gensler.lab18tool", {
        ...
        options: {
            ...
            create: function (event, data) {
                // pass a callback,or simply bind on the "lab18tool:create" event, or both
                //console.log(event, '--callback create event')
                //console.log(data, '--callback create data')
            },
            change: function (event, data) {
                // pass a callback,or simply bind on the "lab18tool:change" event, or both
                //console.log(event, '--callback change event');
                //console.log(data, '--callback change data');
            },
            destroy: function (event, data) {
                // pass a callback,or simply bind on the "lab18tool:destroy" event, or both
        ...
        _create: function () {
        	...
        	var self = this;
        	box.css({"border": "1px solid red", "width": "20px", "height":"20px","float":"right"});
