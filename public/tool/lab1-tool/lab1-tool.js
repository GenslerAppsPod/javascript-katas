    ...
    $.widget("gensler.lab1tool", {
        ...
        options: {
            ...
            create: function (event, data) {
                // pass a callback,or simply bind on the "lab1tool:create" event, or both
                //console.log(event, '--callback create event')
                //console.log(data, '--callback create data')
            },
            change: function (event, data) {
                // pass a callback,or simply bind on the "lab1tool:change" event, or both
                //console.log(event, '--callback change event');
                //console.log(data, '--callback change data');
            },
            destroy: function (event, data) {
                // pass a callback,or simply bind on the "lab1tool:destroy" event, or both
